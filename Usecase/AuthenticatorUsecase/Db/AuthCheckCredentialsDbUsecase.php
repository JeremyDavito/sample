...
class AuthCheckCredentialsDbUsecase extends Usecase
{
   ...
   * @throws Exception
   */
  public function execute(AuthCheckCredentialsUsecaseDto $dto): bool
  {
    try {
      if ($dto->user === null) {
        return false;
      ...
      if (
        isset($_ENV['THOMYRIS_USER']) && $dto->username == $_ENV['THOMYRIS_USER']
      ) {
